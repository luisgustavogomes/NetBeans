...
public class Banco {
    ...
    boolean alterarLimiteCliente(String agencia, String conta, double valor) {
        int indice = verificaIndiceContas(agencia, conta);
        if (contas[indice].getClass() == Corrente.class && indice >= 0) {
            Corrente contaLimite = (Corrente) contas[indice];
    ...
    boolean alterarRendimentoCliente(String agencia, String conta, double valor) {
        int indice = verificaIndiceContas(agencia, conta);
        if (contas[indice].getClass() == Investimento.class && indice >= 0) {
            Investimento contaInvestimento = (Investimento) contas[indice];
