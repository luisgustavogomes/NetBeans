...
public class CarroVO {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 37 * hash + Objects.hashCode(this.proprietario);
        ...
        hash = 37 * hash + (this.arCondicionado ? 1 : 0);
        hash = 37 * hash + (this.tocaFita ? 1 : 0);
        hash = 37 * hash + (this.rodaLiga ? 1 : 0);
        hash = 37 * hash + (this.tapetes ? 1 : 0);
        hash = 37 * hash + (this.alarme ? 1 : 0);
        hash = 37 * hash + Objects.hashCode(this.tipo);
        hash = 37 * hash + Objects.hashCode(this.estado);
        hash = 37 * hash + (int) (Double.doubleToLongBits(this.km) ^ (Double.doubleToLongBits(this.km) >>> 32));
